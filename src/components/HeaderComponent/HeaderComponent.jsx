...
const allDeptCategories=[
  ...
  {id:103,categoryName:"Jewelry, Watches & Sunglasses",href:"/electronics"},
    ...
    <div className="bg-white p-4 sticky top-0 z-10 border-b-2 border-primary-blue">
      <div className="flex items-center justify-between ">
        <a href="#" className="text-white">
          <img src="/logo.png" alt="Logo" className=" w-[160px] h-[20px] lg:w-[200px] lg:h-[50px] object-cover"  />
        </a>
          ...
          {showMobileMenu && (
            <div className="absolute right-0 top-12 bg-primary-light p-2 mt-2 rounded-md z-10 shadow-md">
               <div className="text-black cursor-pointer mb-2">
                <SfIconLocationOn className="h-6 w-6 inline mr-2" onClick={handleOpenModal}  />
                Location
              </div>              
              <div className="text-black cursor-pointer mb-2">
      ...
      <div className="mt-4">
        <div className="flex items-center relative">
          ...
          <button className="text-black mx-4 text-xs md:text-base">Top Products</button>
          <button
          ...
          {showAccounts && (
            <div className="absolute bg-white mt-2 rounded-md shadow-md top-10 md:left-52 w-full md:w-fit z-10">
              ...
              <Link href={Category.href} key={Category.id} className="block p-2">
                {Category.categoryName}
              </Link>))}              
            </div>
          )}
