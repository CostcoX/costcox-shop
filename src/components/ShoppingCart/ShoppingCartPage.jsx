import { SfButton, SfIconAdd, SfIconDelete, SfIconRemove, SfIconSell, SfLink } from '@storefront-ui/react'
    ...
    <>  
      ...
      <div className="flex flex-col pl-4 min-w-[180px] flex-1">
        ...
        <div className="items-center sm:mt-auto sm:flex">
          {/* price */}
          <span className="font-bold sm:ml-auto sm:order-1 typography-text-sm sm:typography-text-lg">{total}</span>
